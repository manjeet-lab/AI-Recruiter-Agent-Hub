...
def get_gemini_api_key() -> str:
    ...
    Resolve the Gemini API key in priority order:
      1. GEMINI_API_KEY environment variable (e.g. from .env)
      2. Already stored in st.session_state from a previous form submission
      3. Return empty string — caller shows the key-entry card
    """
